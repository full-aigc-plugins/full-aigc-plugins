...
| 插件 | ID | 版本 | 定位 | 仓库 |
|------|----|:----:|------|------|
| 🧱 **Blender 制作** | `blender-design` | 0.11.0 | Blender 场景的受控设计、审阅与导出（四 Tab 工作台、供应商能力、视觉里程碑与恢复检查点） | [blender-design-plugin](https://github.com/full-aigc-plugins/blender-design-plugin) |
