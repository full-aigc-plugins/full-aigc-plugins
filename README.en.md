...
|--------|----|:-------:|-------|------------|
| 🧱 **Blender Production** | `blender-design` | 0.7.1 | Controlled design, review, and export of Blender scenes (visual milestones + recovery checkpoints) | [blender-design-plugin](https://github.com/full-aigc-plugins/blender-design-plugin) |
